...
<div class="author-featurette align-left">
	
	<img class="author-img pull-left" src="<?php echo IMG_ADDR."/authors/antho.jpg"; ?>" />
...
<div class="author-featurette align-right">
	<img class="author-img pull-right" src="<?php echo IMG_ADDR."/authors/chris.jpg"; ?>" />
